...
public class Main extends Application {
    ...
    private Image userImg = new Image(this.getClass().getResourceAsStream("images/doyoufart.jpg"));
    private Image dukeImg = new Image(this.getClass().getResourceAsStream("images/pufferfish.png"));
